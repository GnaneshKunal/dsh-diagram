...
- DeepSeek Harness `0.1.5-rc.2`（最新版）。本版本仅面向 `0.1.5` 插件 API，不支持 `0.1.1-rc.2` 及更早的 Harness 发行版。
...
后文各节以短形式 `dsh` 书写；请按你实际的启动方式替换为 `npx -y @deepseek-ai/dsh@0.1.5-rc.2` 或 `pnpm dsh` 前缀。
